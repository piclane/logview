...
public class Line {
     ...
     */
    public static void readLine(BufferedByteReader reader, Charset charset, LineConsumer consumer) throws IOException {
     ...
     * @throws IOException 入出力例外が発生した場合
     */
    public static long skipLine(BufferedByteReader reader) throws IOException {
        while (true) {
            switch (reader.read()) {
                case -1: // EOFに達した場合
                case '\n':
